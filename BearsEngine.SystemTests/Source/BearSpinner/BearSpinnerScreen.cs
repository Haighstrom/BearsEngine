...
internal class BearSpinnerScreen : Screen
{
    ...
    public BearSpinnerScreen(IGameEngine engine, IWindow window, IScreenFactory screenFactory)
        : base()
    {
        _window = window;
        ...
        var b = new Button(1, new Rect(10, 10, 60, 40), Colour.LightGray, GV.Theme, () => engine.ChangeScene(_screenFactory.CreateMainMenuScreen()));
    ...
    private void OnWindowResize(object? sender, EventArgs e)
    {
        ...
        _camera.RemoveAll();
        Repeat.CallMethod(() => _camera.Add(new Bear(Randomisation.Rand((int)_window.ClientSize.X), Randomisation.Rand((int)_window.ClientSize.Y))), _window.WindowWidth * _window.WindowHeight / 3000);
