...
namespace BearsEngine.Worlds
{
    public class TerrainCamera : Camera
    {
        ...
        public TerrainCamera(int[,] map, int defaultIndex, string terrainSpriteSheetPath, int spriteSheetW, int spriteSheetH, int layer, IRect<float> position, float tileSizeW, float tileSizeH)
        ...
        public TerrainCamera(int[,] map, int defaultIndex, string terrainSpriteSheetPath, int spriteSheetW, int spriteSheetH, int layer, IRect<float> position, IRect<float> viewport)
