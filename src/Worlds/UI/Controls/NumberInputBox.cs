          ...
          IFormattable
    {
        ...
        public T Value
        {
            ...
            set
            {
                ...
                ValueChanged?.Invoke(this, new EventArgs<T>(t));
            }
        }
        #endregion
        ...
        private void ConfirmEdit()
        {
            ...
            try
            {
                ...
                if (_resetValue.CompareTo(Value) != 0)
                    ValueChangedByEditing?.Invoke(this, new EventArgs<T>(Value));
            }
            catch
            {
                Value = _resetValue;
        ...
        public event EventHandler<EventArgs<T>> ValueChangedByEditing;
        #endregion
    }
}