    ...
    public class TextInputBox : Entity, IActivatable
    {
        ...
        public string Value
        {
            ...
            set
            {
                _text = value;
                SetTextPositions();
                ValueChanged?.Invoke(this, new EventArgs<string>(_text));
            }
        }
        #endregion
        ...
        private void ConfirmEdit()
        {
            ...
            if (_resetValue != Value)
            {
                ...
                if (ValueChangedByEditing != null)
                    ValueChangedByEditing(this, new EventArgs<string>(Value));
            }
        }
        #endregion
        ...
        public event EventHandler<EventArgs<string>> ValueChangedByEditing;
        #endregion
    }
}