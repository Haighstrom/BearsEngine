    ...
    internal class StreamState
{
	...
	internal int e_o_s;   /* set when we have buffered the last packet in the
		 logical bitstream */
	...
	internal void init(int serialno)
	{
	...
	internal int packetin(Packet op)
	{
