...
public static class Taskbar
{
    ...
    static Taskbar()
    {
        ...
        IntPtr result = Shell32.SHAppBarMessage(SHAppBarMessage_dwMessage.ABM_GETTASKBARPOS, ref data);
        ...
        data.cbSize = (uint)System.Runtime.InteropServices.Marshal.SizeOf(typeof(APPBARDATA));
        result = Shell32.SHAppBarMessage(SHAppBarMessage_dwMessage.ABM_GETSTATE, ref data);
